...
The persistence service requires that resolved directory as an explicit input. It never discovers state from the working directory, home directory, configuration, or a running Gateway.
