...
const fixtureFile = { history: './preserved-history-native-rehearsal.mjs', bootstrap: './topic-bootstrap-native-rehearsal.mjs', 'bootstrap-crash': './topic-bootstrap-crash-rehearsal.mjs', reconcile: './reconcile-native-rehearsal.mjs', 'cli-discovery': './reconcile-cli-discovery.mjs', 'provisioning-primary': './provisioning-primary-native-rehearsal.mjs', 'provisioning-crash': './topic-bootstrap-crash-rehearsal.mjs' }[slice];
