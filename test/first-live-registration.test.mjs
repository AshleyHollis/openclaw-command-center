...
test('the milestone manifest admits scoped capture and capacity review while keeping filing/maintenance triggers unavailable', async () => {
  ...
  assert.deepEqual(manifest.contracts.tools, ['command_center_capture_commitment', 'command_center_open_capacity_review', 'command_center_resolve_source_topic', 'command_center_save_source_note', 'command_center_capture_source_commitment', 'command_center_plan_intake_source', 'command_center_record_intake_outcome', 'command_center_record_intake_receipt', 'command_center_publish_briefing']);
  assert.deepEqual(manifest.contracts.workspaceSessionTurnScheduling, []);
  const h = host(); plugin.register(h.api);
  assert.deepEqual(h.tools, ['command_center_capture_commitment', 'command_center_open_capacity_review', 'command_center_resolve_source_topic', 'command_center_save_source_note', 'command_center_capture_source_commitment', 'command_center_plan_intake_source', 'command_center_record_intake_outcome', 'command_center_record_intake_receipt', 'command_center_publish_briefing']);
