...
test('an exact schema-1 database migrates atomically to schema 9 and preserves source identities', async () => {
  await withState(async (stateDir) => {
    ...
    assert.equal(reopened.getOperatingStatus().schemaVersion, 9);
