...
test('manifest activates the route-registering plugin at Gateway startup', async () => {
  ...
  assert.deepEqual(manifest.contracts?.tools, ['command_center_capture_commitment', 'command_center_open_capacity_review', 'command_center_resolve_source_topic', 'command_center_save_source_note', 'command_center_capture_source_commitment', 'command_center_record_intake_receipt', 'command_center_publish_briefing']);
});
