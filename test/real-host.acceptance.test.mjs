...
async function exerciseRecoveryOnlyHostVariant({ descriptor, buildReceipt, signal }) {
  return withIsolatedWorld(async (recoveryWorld) => {
    ...
    try {
      ...
      assert.equal(releasePerformanceIdentity.hostReceipt.commit, '1eb7aa385dae0eb8c5b926d1288832489126f987', 'the launched runtime must match the exact stable compatibility tuple');
