...
async function exerciseRecoveryOnlyHostVariant({ descriptor, buildReceipt, signal }) {
  return withIsolatedWorld(async (recoveryWorld) => {
    ...
    try {
      ...
      assert.equal(releasePerformanceIdentity.hostReceipt.commit, '28ff72e5fb246ec5fb0aa871be92a98e7c504aaf', 'the launched runtime must match the exact authenticated compatibility tuple');
