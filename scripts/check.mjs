...
const pinnedPackageVersion = '2026.9.1';
if (packageJson.dependencies?.openclaw !== pinnedPackageVersion) throw new Error('OpenClaw host package must be pinned exactly');
if (packageJson.openclaw?.compat?.pluginApi !== '=2026.9.1') throw new Error('OpenClaw plugin API must match the current authenticated host exactly');
