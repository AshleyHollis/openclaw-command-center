...
const focusedRealHostScenarios = Object.freeze({
  ...
  'full-corpus-desktop-to-scale-transition': Object.freeze(['focused-control-ui-migration-readiness', 'focused-control-ui-search-projection', 'focused-full-corpus-fixture', 'authenticated-control-ui-mount', 'focused-scale-session-seeding', 'desktop-primary-journey', 'focused-second-topic-journey']),
