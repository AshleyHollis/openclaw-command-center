...
export function mountTopicSidebar(container, context, viewState = createTopicSidebarState()) {
  ...
  const visibleTopics = () => [...allTopics(), ...(destination?.archived ?? []).filter(topic => topic?.usable === true && topic?.lifecycle === 'archived')];
