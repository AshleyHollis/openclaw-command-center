  ...
  function render({ preserveDomExpansion = true } = {}) {
    ...
    for (const [category, label] of [['project', 'Projects'], ['area', 'Areas'], ['resource', 'Resources'], ['archive', 'Archives']]) {
      ...
      for (const entry of entries) {
        ...
        if (recovering) { const notice = document.createElement('p'); notice.textContent = 'Notes require Source Recovery. Verified Conversations remain available.'; children.append(notice); }
