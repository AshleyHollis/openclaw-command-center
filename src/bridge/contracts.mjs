...
function actionResultSchema(method) {
  ...
  if (method.startsWith('command-center.v1.open-loops.')) {
    ...
    if (method.endsWith('.get')) {
      ...
      return Object.freeze({ type: 'object', additionalProperties: false, properties: Object.freeze({ schemaVersion: { const: 1 }, loop, evidence: { type: 'array', items: evidence }, followUp }), required: ['schemaVersion', 'loop', 'evidence'] });
    }
    ...
    if (method.endsWith('.resume-follow-up')) return Object.freeze({ type: 'object', additionalProperties: false, properties: Object.freeze({ schemaVersion: { const: 1 }, disposition: { enum: ['duplicate', 'superseded'] }, loop, reminder }), required: ['schemaVersion', 'disposition', 'loop'] });
