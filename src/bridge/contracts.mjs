...
export function validateBridgeRequest(method, params, { mutation = WRITE_METHODS.includes(method) } = {}) {
  ...
  if (method.endsWith('.open-loops.decide') && (params.decision === 'correct-date') !== (params.dueAt !== undefined)) throw sourceError('invalid-request', 'Only a corrected-date decision requires dueAt.');
