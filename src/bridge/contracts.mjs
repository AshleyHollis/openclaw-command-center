...
function actionResultSchema(method) {
  ...
  if (method.startsWith('command-center.v1.open-loops.')) {
    ...
    if (method.endsWith('.get')) {
      ...
      const interpretation = Object.freeze({ type: 'object', additionalProperties: false, properties: Object.freeze({ status: { enum: ['pending', 'proposal-saved', 'review-required'] } }), required: ['status'] });
