...
export const FIRST_LIVE_COMMANDS = Object.freeze({
  bridge: Object.freeze([
    ...
    'command-center.v1.open-loops.intake-selected', 'command-center.v1.open-loops.decide', 'command-center.v1.open-loops.clarify', 'command-center.v1.open-loops.resume-follow-up',
